...
public class NumberCategoryUtility { public static NumberCategory checkAmicable() { return (number1, number2) -> { int sumDivisors1 = sumDivisors(number1); int sumDivisors2 = sumDivisors(number2); return sumDivisors1 == number2 && sumDivisors2 == number1; }; }
